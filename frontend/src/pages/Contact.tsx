  ...
  return (
    <body className="flex flex-col items-center">
        ...
        <section className="w-full flex flex-col items-center self-center">
          ...
          <form ref={contactRef} onSubmit={(e:any)=>sendEmail(e)} className="w-3/5 text-black mb-3">
            <hr/>
            <div className="name-form flex flex-row h-16 border-none items-center">
              <div className="bg-gray-300 w-1/4 h-full">
                <p className='text-center h-full flex flex-col justify-center'>name</p>
              </div>
            ...
            <div className="mail-form flex flex-row h-16 border-none items-center">
              <div className="bg-gray-300 w-1/4 h-full">
                <p className='text-center h-full flex flex-col justify-center'>e-mail</p>
              </div>
              <div className="flex flex-row justify-center w-full">
            ...
            <div className="inquiry-form flex flex-row h-64 border-none items-center">
              <div className="bg-gray-300 w-1/4 h-full">
                <p className='text-center h-full flex flex-col justify-center'>Content</p>
              </div>
              <div className="flex flex-row justify-center w-full h-full py-5">
